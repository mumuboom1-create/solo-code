...
with sftp.file('/www/wwwroot/test.susufuture.com/test_parser.php', 'w') as f:
    f.write(content)

# Run and capture output
stdin, stdout, stderr = client.exec_command("php /www/wwwroot/test.susufuture.com/test_parser.php 2>&1")
